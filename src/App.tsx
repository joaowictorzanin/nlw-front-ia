      ...
      <main className="flex-1 p-6 flex gap-6">
        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            ...
            <Button type="submit" className="w-full bg-white hover:bg-gray-300">Carregar video <Upload className="w-4 h-4 ml-2"/></Button>
          </form>
          ...
          <form className="space-y-6">
            <div className="space-y-2">
              ...
              <Select >
                ...
                <SelectContent>
                  <SelectItem value="ytTitle">
                    Titulo do Youtube
                  </SelectItem>
                  <SelectItem value="ytDescription">
            ...
            <Button type="submit" className="w-full bg-white hover:bg-gray-300">Executar <Wand2 className="w-4 h-4 ml-2"/></Button>
          </form>
        </aside>
      </main>
    </div>
